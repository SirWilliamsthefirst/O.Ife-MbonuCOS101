fn main() {
    ...
    println!("\nThe {} is informed by the aspiration to train elecrical/electronic engineering professionals in the areas of design, building and maintenance of electrical control systems,", n4);
